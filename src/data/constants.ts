// Ayush Prakash Tiwari Portfolio - Skills & Experience Data
...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.REACT]: {
    ...
    name: "react",
    label: "React",
    shortDescription: `component-driven UI magic, hooks all day! ⚛️🔥`,
    color: "#61dafb",
  ...
  [SkillNames.NEXTJS]: {
    ...
    label: "Next.js",
    shortDescription:
      "the full-stack React framework, server-side rendering ftw! 👑📜",
    color: "#fff",
  ...
  [SkillNames.PYTHON]: {
    ...
    label: "Python",
    shortDescription:
      "the Swiss Army knife of programming, ML's best friend! 🐍🔥",
    color: "#3776ab",
  ...
  [SkillNames.JAVA]: {
    ...
    name: "java",
    label: "Java",
    shortDescription: "write once, run everywhere, enterprise vibes! ☕💼",
    color: "#ed8b00",
  ...
  [SkillNames.CPP]: {
    ...
    name: "cpp",
    label: "C++",
    shortDescription: "low-level power, DSA grind machine! ⚡🏋️",
    color: "#00599c",
  ...
  [SkillNames.SPRING_BOOT]: {
    ...
    name: "spring_boot",
    label: "Spring Boot",
    shortDescription: "Java's favorite framework for building microservices! 🌱🚀",
    color: "#6db33f",
  ...
  [SkillNames.KAFKA]: {
    ...
    name: "kafka",
    label: "Apache Kafka",
    shortDescription: "event streaming at scale, messages go brrr! 📨⚡",
    color: "#231f20",
  ...
  [SkillNames.REDIS]: {
    ...
    name: "redis",
    label: "Redis",
    shortDescription: "in-memory caching, blazing fast data store! 🔴⚡",
    color: "#dc382d",
  ...
  [SkillNames.TENSORFLOW]: {
    ...
    name: "tensorflow",
    label: "TensorFlow",
    shortDescription: "deep learning powerhouse, neural nets go crazy! 🧠🤖",
    color: "#ff6f00",
  ...
  [SkillNames.MYSQL]: {
    ...
    name: "mysql",
    label: "MySQL",
    shortDescription: "the OG relational database, queries go brr! 🐬💾",
    color: "#4479a1",
